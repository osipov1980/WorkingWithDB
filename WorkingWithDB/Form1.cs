...
namespace WorkingWithDB
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectionString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = c:\users\igor\documents\visual studio 2015\Projects\WorkingWithDB\WorkingWithDB\Database.mdf; Integrated Security = True";
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                label7.Text = "Rows 'Name' and 'Price' must be filled!";
            }
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (!string.IsNullOrEmpty(textBox4.Text) && !string.IsNullOrWhiteSpace(textBox4.Text))
            {
                ...
                label8.Text = "ID must be filled!";
            }
            else
            {
                label8.Visible = true;

                label8.Text = "Rows 'ID', 'Name' and 'Price' must be filled!";
            }
        }
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                label9.Text = "Rows 'Name' and 'Price' must be filled!";
            }
        }
    }
}
